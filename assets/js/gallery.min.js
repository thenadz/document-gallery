...
(function(b,d){d.fadeOut("fast",function(){c(this).attr("src",a[b]);c(this).fadeIn("fast")})})(d,b)}h()}var e,f;c(document).ready(function(){g();c("body").delegate(".dg-paginate-wrapper a.paginate","click",function(a){var d=c(this).closest(".dg-paginate-wrapper"),b=d.children("div[data-shortcode]").data("shortcode");b.hasOwnProperty("skip")||(b.skip=0);c(this).hasClass("left")?b.skip-=b.limit:b.skip+=b.limit;k(b,d);a.preventDefault()})})})(jQuery);
